...
class Airfield(ControlPoint):
    ...
    def can_operate(self, aircraft: AircraftType) -> bool:
        ...
        if not (aircraft.helicopter or dcs.planes.AV8BNA) and not self.airport.runways:
            return False
        else:
...
class Fob(ControlPoint):
    ...
    def can_operate(self, aircraft: AircraftType) -> bool:
        ...
        return (aircraft.helicopter or dcs.planes.AV8BNA) and self.total_aircraft_parking > 0
